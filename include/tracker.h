...
private:
    ...
    void resampleByPoints(const IplImage* input, const int srMar, const Points &points,
            IplImage* output);
    ...
    int getClosestCenterBufIndex(CvPoint mass, const vector<Points> &buf, const vector<bool> &empty);
